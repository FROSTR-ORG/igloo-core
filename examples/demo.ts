import { 
  ...
  async function demoEchoFunctionality(keyset: { groupCredential: string; shareCredentials: string[] }) {
  ...
  async function demoNodeManagement(keyset: { groupCredential: string; shareCredentials: string[] }) {
